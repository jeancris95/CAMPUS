        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="table-responsive">
                    <table id="tablaUsuariosAlta" class="table table-striped table-bordered table-condensed" style="width:100%">
